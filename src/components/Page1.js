      ...
      <div className="container mx-auto lg:ml-0 lg:mr-auto lg:pr-[5vw] relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-4 order-2 lg:order-1 ml-0 md:ml-8 lg:ml-16">
            ...
            <h6 className="text-xl md:text-2xl mt-4 opacity-0 transform -translate-x-full animate-slide-in">
          ...
          <div className="flex flex-col items-center lg:items-end space-y-8 order-1 lg:order-2 px-4 sm:px-8 lg:px-0 lg:mr-16">
            <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-6xl xl:text-7xl  bg-abusinees fontmycustom text-center lg:text-right w-full">WEBDADDY</h2>
            ...
            <h5 className="blend text-center lg:text-right text-lg md:text-xl max-w-sm opacity-0 transform translate-y-full animate-slide-up-5">
