    ...
    <div className="flex-none w-screen h-screen bg-[#333] text-[#e0e0e0] font-['Inter',sans-serif] relative z-10 overflow-hidden">
      <div className="absolute inset-0 flex flex-col justify-center p-4 sm:p-6 md:p-8 lg:p-12">
        <div className="vertical-text-container hidden lg:flex absolute left-0 top-0 bottom-0 items-center">
          <div ref={aboutRef} className="vertical-text text-[10vw] xl:text-[10rem] bg-abusinees fontmycustom" data-animation="slide-in-bottom">
            About
          </div>
        </div>
        <div className="w-full max-w-[90vw] mx-auto flex flex-col justify-between h-full lg:ml-[15vw]">
          <div className="lg:hidden text-4xl sm:text-5xl md:text-6xl mb-4 bg-abusinees fontmycustom" data-animation="slide-in-left">
            About Us
          </div>
          <div className="flex flex-col lg:grid lg:grid-cols-3 gap-4 lg:gap-8 flex-grow">
            <div ref={usRef} className="flex flex-col justify-start lg:justify-center">
              <h1 className="text-sm sm:text-base md:text-lg font-normal mb-2 lg:mb-4 bg-abusinees" data-animation="slide-in-left">
              ...
              <p className="hidden lg:block text-[6vw] xl:text-[5rem] text-stroke leading-none fontmycustom bg-abusinees" data-animation="slide-in-left">us</p>
            </div>
            
            <div className="flex flex-col justify-start lg:justify-center">
              <div className="space-y-2 lg:space-y-4">
                <div ref={visionRef} className="bg-abusinees" data-animation="slide-in-left">
                ...
                <div ref={missionRef} className="bg-abusinees" data-animation="slide-in-left">
            ...
            <div 
              ref={focusRef} 
              className={`flex flex-col justify-start lg:justify-center transition-opacity duration-1000 ease-in-out ${isFocusVisible ? 'opacity-100' : 'opacity-0'}`}
            >
